 ...
 * @author sajid
 */
public class LandOwner extends User implements Serializable{
    ...
    public void provideFees(TableView<Fees> fundsTableView) throws IOException {
        Alert a = new Alert(Alert.AlertType.INFORMATION);
  ...
  private ObservableList<Owner> getOwner() {
    ...
    public static boolean landownergetinfo(String name, String gender, String age, String nid, String phone, String address, String registrationNumber, String landArea, String landLocation, LocalDate registrationDate)throws FileNotFoundException, IOException{
       
        LandOwnerinformation landbuyerinfo =new LandOwnerinformation(
                      
                  name,gender,age,nid,phone,address,registrationNumber,landArea,landLocation,registrationDate
                );
   File f = new File("LandOwnerrinfo.bin");
