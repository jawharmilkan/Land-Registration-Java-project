 ...
 * @author Admin
 */
public class HRCheckLeaveRequestController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            f = new File("HRVLLeaveRequests.bin");
            fis = new FileInputStream(f);
            ois = new ObjectInputStream(fis);
            HRVLLeaveRequests emp;
            try{
                showTextArea.setText("");
                while(true){
                    emp = (HRVLLeaveRequests)ois.readObject();
