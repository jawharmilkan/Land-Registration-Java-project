...
import modelclass.CommitteeInfo;
 ...
 * @author jawhar
 */
public class EmployeeViewInfoScene_g1Controller implements Initializable {
       ...
       ObservableList<CommitteeInfo> committeeInfoList = FXCollections.observableArrayList();
        ...
        try
        {
            ...
            if(!f.exists())
            {
                ...
                a.setContentText("userAccounts.bin file doesn't exist");
                a.showAndWait();
            }
            else
            {
