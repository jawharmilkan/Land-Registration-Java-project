...
public class LandOwnerGovtFeesScene_g6Controller implements Initializable {
    ...
    @FXML
    private TableView<Fees> feesTableView;
    @FXML
    ...
    private ObservableList<Fees> getFees() {
        ...
        try {
            ...
            if (f.exists()) {
                ...
                while (sc.hasNextLine()) {
                    ...
                    feesList.add(new Fees(tokens[0], tokens[1], tokens[2]));
                }
            }
