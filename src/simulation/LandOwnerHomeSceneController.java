...
public class LandOwnerHomeSceneController implements Initializable {
    ...
    {
         Parent scene2Parent = FXMLLoader.load(getClass().getResource("LandOwnerShowInfo.fxml"));
         Scene scene2 = new Scene(scene2Parent);
         Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
    ...
    @FXML
    private void setuserinfobtn(MouseEvent event) throws IOException {
        
        Parent scene2Parent = FXMLLoader.load(getClass().getResource("LandOwnerSetinfo.fxml"));
         Scene scene2 = new Scene(scene2Parent);
         Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
