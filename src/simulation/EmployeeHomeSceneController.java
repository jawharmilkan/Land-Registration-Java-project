...
public class EmployeeHomeSceneController implements Initializable {
    ...
    @FXML
    private void recivedMessafeButtonOnAction(ActionEvent event) throws IOException 
    {
         Parent scene2Parent = FXMLLoader.load(getClass().getResource("employeeRecivedMessageScene_g7.fxml"));
         Scene scene2 = new Scene(scene2Parent);
         Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
